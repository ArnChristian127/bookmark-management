...
export default function ModalMsg({ icons, title, message, color, onClose }: ModalWarningMsgProps) {
    return (
        <>
            ...
            <div className="inset-0 fixed flex items-center justify-center px-3 z-50">
                <div className="bg-white p-5 rounded-lg w-100 flex items-center flex-col space-y-3">
