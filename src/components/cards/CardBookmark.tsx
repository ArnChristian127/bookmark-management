...
export default function Bookmark({ className, title, description, url, deleteBookmark, editBookmark }: BookmarksProps) {
    return (
        <>
            <div className={`border border-gray-300 p-5 rounded-lg shadow-lg grid grid-cols-1 ${className}`}>
                ...
                <div className="flex justify-between items-center mt-3 gap-5">
                    ...
                    <button onClick={deleteBookmark} className="bg-red-400 hover:bg-red-500 focus:bg-red-500 text-white w-full rounded-lg py-2">Delete</button>
                </div>
            </div>
        </>
    )
